...
with open(f'C:/Users/algez/Downloads/ArabicSafetyProject1/datasets/Trigrams/BIAS/results.csv', 'a', newline='', encoding='utf-8') as csvfile:
    ...
    for file in files_names:
        Test_file_path = f'C:/Users/algez/Downloads/ArabicSafetyProject1/datasets/Trigrams/BIAS/{file}.csv'
